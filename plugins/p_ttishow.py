...
async def setwelcome_command(bot, message):
...
async def setgoodbye_command(bot, message):
    if not message.from_user.id in ADMINS:
        return await message.reply(
            "❌ You are not allowed to access this command!"
        )
...
async def welcome_command(bot, message):
    settings = await get_settings(message.chat.id)
    if settings["welcome"]:
        return await message.reply(
...
async def goodbye_command(bot, message):
    settings = await get_settings(message.chat.id)
    if settings["goodbye"]:
        return await message.reply(
...
async def nowelcome_command(bot, message):
    settings = await get_settings(message.chat.id)
...
async def nogoodbye_command(bot, message):
    settings = await get_settings(message.chat.id)
...
async def delwelcome_command(bot, message):
    if not message.from_user.id in ADMINS:
        return await message.reply(
            "❌ You are not allowed to access this command!"
        )
...
async def delgoodbye_command(bot, message):
    if not message.from_user.id in ADMINS:
        return await message.reply(
            "❌ You are not allowed to access this command!"
        )
